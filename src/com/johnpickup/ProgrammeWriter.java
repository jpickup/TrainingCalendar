...
public class ProgrammeWriter {
	...
	public void write(Programme programme) throws IOException {
	    ...
	    List<PlannedWorkout> workouts = new ArrayList<PlannedWorkout>(programme.getWorkouts());
	    Collections.sort(workouts, new Comparator<PlannedWorkout>() {
			@Override
			public int compare(PlannedWorkout arg0, PlannedWorkout arg1) {
